...
<!--{template home/space_head}-->
		...
		<!--{if in_array($_GET['op'], array('base', 'buy', 'transfer', 'exchange'))}-->
			<ul class="bus_credit bus_spacebox mt10">
			<!--{eval $creditid=0;}-->
		...
		<!--{if $_GET['op'] == 'base'}-->
			<table summary="{lang memcp_credits_log_transaction}" cellspacing="0" cellpadding="0" class="dt bus_w100 mtm">
				<caption>
					<h2 class="mbm xs2">
		...
		<!--{elseif $_GET['op'] == 'buy'}-->
			...
			<form id="addfundsform" name="addfundsform" method="post" autocomplete="off" action="home.php?mod=spacecp&ac=credit&op=buy" onsubmit="ajaxpost(this.id, 'return_addfundsform');">
				...
				<table cellspacing="0" cellpadding="0" class="tfm mtn">
					<tr>
						<th style="width:30%">{lang mode_of_payment}</th>
					...
					<tr>
						<th>&nbsp;</th>
						<td colspan="2">
							<button type="submit" name="addfundssubmit_btn" class="bus_btn post_msg_btn" id="addfundssubmit_btn" value="true"><em>{lang memcp_credits_addfunds}</em></button>
						</td>
					</tr>
		...
		<!--{elseif $_GET['op'] == 'transfer'}-->
			...
			<form id="transferform" name="transferform" method="post" autocomplete="off" action="home.php?mod=spacecp&ac=credit&op=transfer" onsubmit="ajaxpost(this.id, 'return_transfercredit');">
				...
				<table cellspacing="0" cellpadding="0" class="tfm mtn">
					<tr>
						<th style="width:30%">{lang memcp_credits_transfer}</th>
						<td style="width:70%">
							<input type="text" name="transferamount" id="transferamount" class="px" size="5" style=" width:70%"  value="0" />
							&nbsp;{$_G[setting][extcredits][$_G[setting][creditstransextra][9]][title]}&nbsp;
							<br />{lang credits_give}&nbsp;
							<br /><input type="text" name="to" id="to" class="px" size="15" style=" width:70%"  />
							<br />
					...
					<tr>
						...
						<td><input type="password" name="password" class="px" style=" width:70%"  value="" /></td>
					</tr>
					<tr>
						<th>{lang credits_transfer_message}</th>
						<td><input type="text" name="transfermessage" class="px"  style=" width:70%" size="40" /></td>
					</tr>
					<tr>
						<th>&nbsp;</th>
						<td colspan="2">
							<button type="submit" name="transfersubmit_btn" id="transfersubmit_btn" class="bus_btn post_msg_btn" value="true"><em>{lang memcp_credits_transfer}</em></button>
			...
			<form id="exchangeform" name="exchangeform" method="post" autocomplete="off" action="home.php?mod=spacecp&ac=credit&op=exchange&handlekey=credit" onsubmit="showWindow('credit', 'exchangeform', 'post');">
				...
				<table cellspacing="0" cellpadding="0" class="tfm mtn">
					<tr>
						...
						<td class="pns">
							<input type="text" id="exchangeamount" name="exchangeamount" class="px" size="5" style="width: 50%;" value="0" onkeyup="exchangecalcredit()" />
							...
							&nbsp;{lang credits_need}&nbsp;
							<input type="text" id="exchangedesamount" class="px" size="5" style="width: 50%;" value="0" disabled="disabled" />
