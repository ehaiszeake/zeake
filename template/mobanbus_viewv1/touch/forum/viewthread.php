...
{/if}
<script type="text/javascript" src="template/mobanbus_viewv1/viewv1_st/js/mobanbusjs.js"></script>
...
<!--{if $post[first]}-->
	...
	<div class="bus_indexbg_col s01 mobanbus_vbg"><img src="$_G[siteurl]{eval echo(getforumimg($thread['aid'],0,600,500))}" /></div>
	<div class="bus_relative" style="height:250px; bottom:0px;">
	<span class="bus_back"><a class="head_ico icon-angle-left" href="forum.php?mod=forumdisplay&fid=$_G['forum'][fid]"></a></span>
	<div class="mobanbus_bd bus_vtt">
...
<!--{else}-->
   <div class="bus_sd bus_replybd plc cl" id="pid$post[pid]">
       ...
       <div class="message" id="isfirst">
			...
			<div id="mcover" onclick="weChat()" style="display:none;"><img src="$_G[siteurl]template/mobanbus_viewv1/viewv1_st/img/wechatbus.png" /></div>
       </div>
  </div>
