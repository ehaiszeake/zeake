...
<style type="text/css">
.postalbum { background-color:#343434; display:none; float:left; overflow:hidden; padding:0 0 1px 0; position: relative; top:0; width:100%; z-index:80; }
.postalbum_h { height:44px; left:0; line-height:44px; position:absolute; top:40px; width:100%; z-index:90; opacity:0.7; background:black; }
