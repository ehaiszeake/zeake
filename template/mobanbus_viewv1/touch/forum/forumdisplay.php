...
<script src="template/mobanbus_viewv1/viewv1_st/js/jquery.infinitescroll.js" type="text/javascript"></script>
<!--{eval require_once(DISCUZ_ROOT."./source/function/function_post.php");}-->
<div class="bus_w100 bus_fl">

<div class="bus_w100 bus_fl bus_bg000 pt10 mt10 bus_forum_guid">
	<div class="tit">
	<!--{if $_G['forum'][icon]}-->
...
<div class="clear"></div>
	...
	<!--{if $_G['forum_threadcount']}-->
		...
		<ul id="waterfall" class="mobanbus_item mobanbus_scroll">
			...
			<img class="bus_newslist_pic" src="{eval echo(getforumimg($thread['aid'],0,120,120))}" alt="{$thread[subject]}"/>
