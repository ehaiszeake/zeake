                ...
                <div class="ad_box">
                    <div class="ad1_place f_cf">
                        <div class="ad1_place1 f_fl">
                        	<a href="<?php echo ($index['data']['ad'][0]['url']); ?>">
                        	<img src="<?php echo (webimg($index['data']['ad'][0]['img'],$website)); ?>" class="placeholderImg f_vat" title="<?php echo ($index['data']['ad'][0]['name']); ?>"/>
                        	<div class="texiao"></div>
                        	</a>
                        </div>
                        <div class="ad1_place2 f_fl">
                            <div class="ad1_place2_1">
                            	<a href="<?php echo ($index['data']['ad'][1]['url']); ?>">
                            	<img src="<?php echo (webimg($index['data']['ad'][1]['img'],$website)); ?>" class="placeholderImg2 f_vat" title="<?php echo ($index['data']['ad'][1]['name']); ?>"/>
                            	<div class="texiao"></div>
                            	</a>
                            </div>
                            <div class="ad1_place2_2">
                            	<a href="<?php echo ($index['data']['ad'][2]['url']); ?>">
                            	<img src="<?php echo (webimg($index['data']['ad'][2]['img'],$website)); ?>" class="placeholderImg2 f_vat" title="<?php echo ($index['data']['ad'][2]['name']); ?>"/>
                            	<div class="texiao"></div>
                            	</a>
                            </div>
                        </div>
                    ...
                    <div id="index_slideBox" class="index_slideBox ad2_place_list">
                        ...
                        <ul class="f_cf swiper-wrapper" id="top_article">
							<?php if(is_array($index[data][top_article])): $i = 0; $__LIST__ = $index[data][top_article];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i; if(item.type == 2): if(defined("link")): ?>video_detail.php?id=<?php echo ($item["id"]); endif; ?>
								<?php else: ?>
									<?php if(defined("link")): ?>article_detail_<?php echo ($item["id"]); ?>.php<?php endif; endif; ?>
								
								<li class="f_fl swiper-slide" style="'+sy+'">
								<div class="ad2_place_img">
								<a href="article_detail_<?php echo ($item["id"]); ?>.php">
								<img src="<?php echo (webimg($item["img"],$website)); ?>" class="placeholderImg2 f_vat"/>
								</a>
								</div>
								<p><a href="article_detail_<?php echo ($item["id"]); ?>.php"><?php echo ($item["title"]); ?></a></p> 
								<span class="lbl_green"><?php echo ($item["author"]); ?></span>
								<span class="view_num"><?php echo ($item["pv"]); ?></span> 
											...
											if(item.type==3) { 
												var img=item.img;
													...
													if(item.skip_url) { 
														...
														str4+='	<div class="video_cover_box f_pr"><a href="video_detail.php?id='+item.id+'"" class="f_db"><img src="'+img+'" width="100%"/></a><div class="play_ico f_pa"></div></div>';
